      ...
      <div className="relative z-10">
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
                ...
                <SelectContent>
                  {tournamentFormat === 'group_knockout' ? (
                    ...
                    <>
                      ...
                      <SelectItem value="matches">Partidos</SelectItem>
                      <SelectItem value="rounds">Jornadas</SelectItem>
                      <SelectItem value="teams">Equipos</SelectItem>
                    </>
                  )}
                </SelectContent>
            ...
            <TabsList className={`hidden md:grid w-full backdrop-blur-xl bg-white/10 border-white/20 ${tournamentFormat === 'group_knockout' ? 'grid-cols-4' : 'grid-cols-4'
              }`}>
              {tournamentFormat === 'group_knockout' ? (
                <>
                                  ...
                                  {groupStandings[groupName].map((standing, index) => {
                                    ...
                                    return (
                                      <tr
                                        ...
                                        className={`border-b border-white/20 hover:bg-white/5 ${isQualified ? 'bg-green-500/10' : ''
                                          }`}
                                      >
                                        <td className="py-2 text-sm">
                                          <span className={`font-bold drop-shadow ${isQualified ? 'text-green-300' : 'text-white'
                                            }`}>
                                            {index + 1}
                                          </span>
                                        </td>
