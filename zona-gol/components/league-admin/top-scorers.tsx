...
export function TopScorers({ leagueId }: TopScorerProps) {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-gray-900">Tabla de Goleadores</h2>
        <p className="text-gray-600">Ranking de goleadores de la liga</p>
      </div>
        ...
        <CardContent>
          {loading ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-600">No hay goles registrados en la liga todavía</p>
            </div>
          ) : (
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div className="text-center order-1">
                ...
                <div className="bg-white p-4 rounded-b-lg border-t-4 border-gray-400">
                  <p className="font-bold text-lg">{scorers[1].player_name}</p>
                  <p className="text-sm text-gray-600">{scorers[1].team_name}</p>
              ...
              <div className="text-center order-2">
                ...
                <div className="bg-white p-4 rounded-b-lg border-t-4 border-yellow-500">
                  <p className="font-bold text-xl">{scorers[0].player_name}</p>
                  <p className="text-sm text-gray-600">{scorers[0].team_name}</p>
              ...
              <div className="text-center order-3">
                ...
                <div className="bg-white p-4 rounded-b-lg border-t-4 border-orange-600">
                  <p className="font-bold text-lg">{scorers[2].player_name}</p>
                  <p className="text-sm text-gray-600">{scorers[2].team_name}</p>
