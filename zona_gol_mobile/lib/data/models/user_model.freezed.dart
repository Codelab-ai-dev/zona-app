...
abstract class $UserModelCopyWith<$Res> {
  ...
  $Res call(
      ...
      @JsonKey(name: 'user_role') String role,
...
class _$UserModelImpl extends _UserModel {
  const _$UserModelImpl(
      ...
      @JsonKey(name: 'user_role') required this.role,
  ...
  @override
  String toString() {
    return 'UserModel(id: $id, email: $email, name: $name, phoneNumber: $phoneNumber, profilePhotoUrl: $profilePhotoUrl, role: $role, leagueId: $leagueId, teamId: $teamId, isActive: $isActive, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, email, name, phoneNumber,
      profilePhotoUrl, role, leagueId, teamId, isActive, createdAt, updatedAt);
...
abstract class _UserModel extends UserModel {
  const factory _UserModel(
          ...
          @JsonKey(name: 'user_role') required final String role,
